    ...
    <div class="row">
        <div class="col-md-12">
          <nav class="navbar navbar-expand-md navbar-dark bg-dark">
            <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="80" height="50" viewBox="0 0 1280.000000 640.000000" preserveAspectRatio="xMidYMid meet">
              <g transform="translate(0.000000,640.000000) scale(0.100000,-0.100000)" fill="#03a9f4" stroke="none">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="menu">
              <ul class="nav">
                <li class="nav-item"><router-link to="/juegos" class="nav-link active">Inicio</router-link></li>
                <li class="nav-item"><router-link to="/tareas" class="nav-link active">Tareas</router-link></li>
                <li class="nav-item"><router-link to="/noticias" class="nav-link active">Noticias</router-link></li>
              </ul>
            </div>
            <form class="form-inline">
              <button type="button" class="btn btn-primary btn-xs mr-2" v-b-modal.login>Login</button>
              <button type="button" class="btn btn-primary btn-xs" v-b-modal.register>Register</button>
            </form>
          </nav>
        </div>
      </div>
    ...
    >
      <form ref="form">
        ...
        <b-form-group
          label="Genero:"
          label-for="gen-input"
          invalid-feedback="Campos necesarios*"
        >
          <b-form-select
            :options="generos"
          ></b-form-select>
        </b-form-group>
        <b-form-group label="Redes Sociales:">
          <b-form-input required></b-form-input>
        </b-form-group>
...
.col-md, .col-md-1, .col-md-10, .col-md-11, .col-md-12, .col-md-2, .col-md-3, .col-md-4, .col-md-5, .col-md-6, 
